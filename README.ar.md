...
| Antigravity | أصلي | `.agents/skills` |
...
| `group add <group> <identifier>` | إضافة مهارة أو مصدر `owner/repo` أو مجموعة أخرى إلى مجموعة |
| `group remove <group> <identifier>` | إزالة مهارة أو مصدر `owner/repo` أو مجموعة أخرى من مجموعة |
